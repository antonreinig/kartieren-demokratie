      ...
      <main className="flex w-full max-w-4xl flex-col items-center justify-center text-center space-y-8">
        <div className="space-y-4">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
            Kartieren <span className="text-yellow-500">Demokratie</span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          <Link href="/create">
            <Button className="rounded-full px-8 py-6 text-lg bg-yellow-400 hover:bg-yellow-500 text-black shadow-lg hover:shadow-xl transition-all font-bold">
